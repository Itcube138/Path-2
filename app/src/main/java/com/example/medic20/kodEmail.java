...
public class kodEmail extends AppCompatActivity { //окно с запросом кода подтверждения. Окно с картой пациента. Класс создан 22.03.2023, Автор: Михалков Вадим
